...
--
-- Name: index_mains_on_number; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_mains_on_number ON public.mains USING btree (number);
